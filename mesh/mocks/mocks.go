...
func (m *MockconservativeState) ApplyLayer(arg0 *types.Block, arg1 []*types.Block) ([]*types.Transaction, error) {
	m.ctrl.T.Helper()
...
func (m *MockconservativeState) RevertState(arg0 types.LayerID, arg1 []*types.Block) (types.Hash32, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RevertState", arg0, arg1)
	ret0, _ := ret[0].(types.Hash32)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockconservativeStateMockRecorder) RevertState(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RevertState", reflect.TypeOf((*MockconservativeState)(nil).RevertState), arg0, arg1)
}
